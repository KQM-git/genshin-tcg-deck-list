                ...
                <div class="flex flex-col p-5 bg-[#2D282F] border-x-2 border-b-2 border-[#584F65] rounded-b-xl min-h-[400px]">
                    <div class="w-full flex flex-row justify-between items-center">
                        <div class="flex flex-row justify-start items-center">
                            ...
                            >
                                <div
                                    v-for="point of card.skills.find(skill => skill.name === 'Description').points"
                                    :key="point.point_type"
                                    :style="`backgroundImage: url(${require(`~/assets/icons/cost/${point.point_count === 0 ? 'white' : point.point_type}.png`)}); text-shadow: -1px -1px 0 #333, 1px -1px 0 #333, -1px 1px 0 #333, 1px 1px 0 #333`"
